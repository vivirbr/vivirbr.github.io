...
const Services = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      category: 'Community Engagement',
      description: 'Created culturally-sensitive media content and advocacy materials to amplify indigenous voices in forest conservation efforts.',
    ...
    },
    {
      ...
      category: 'Data Solutions',
      description: 'Implemented IoT sensor network and data platform for real-time urban air quality monitoring and public health alerts.',
    ...
    },
    {
      ...
      category: 'Policy Analysis',
      description: 'Produced evidence-based policy briefs on climate adaptation strategies tailored to regional vulnerabilities and capacities.',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              ...
              to transforming complex sustainability data into actionable solutions.
            </p>
          </div>
        </div>
      </section>
                ...
                <Card key={index} className="border-border hover:shadow-lg transition-smooth">
                  <CardHeader>
                    <div className="flex items-start gap-4 mb-4">
                      <div className={`w-12 h-12 ${colorClass} circle-accent flex items-center justify-center flex-shrink-0`}>
          ...
          <Card className="border-primary/20 bg-gradient-to-r from-primary/5 to-secondary/5">
            <CardContent className="p-8 md:p-12 text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a
                  href="mailto:info@diversa.earth?subject=Project Consultation Request"
