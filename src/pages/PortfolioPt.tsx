...
const PortfolioPt = () => {
  const projects: Project[] = [
    ...
    },
    {
      ...
      description:
        'O Do Pasto ao Prato é uma iniciativa de ciência cidadã, cofundada por um dos cofundadores da Diversa, junto com a UCLouvain, Stockholm Environmental Institute e Global Canopy, criada para trazer transparência à cadeia da carne bovina no Brasil. Ao escanear os selos dos produtos no supermercado, o consumidor descobre os riscos ambientais e sociais associados à carne que compra: desmatamento, focos de incêndio, direitos trabalhistas e conflitos em terras indígenas. A Diversa trabalhou no desenvolvimento tanto do aplicativo móvel quanto do site, traduzindo dados complexos de rastreabilidade em uma ferramenta acessível que fortalece o consumo consciente.',
