...
export const Hero = () => {
  ...
  return (
    <section className="pt-16 min-h-screen flex items-center circle-bg-pattern relative overflow-hidden">
      {/* Background gradient circles */}
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-20 right-10 w-96 h-96 bg-gradient-to-br from-primary/10 to-transparent rounded-full blur-3xl animate-float-slow"></div>
        <div className="absolute bottom-20 left-10 w-80 h-80 bg-gradient-to-br from-secondary/10 to-transparent rounded-full blur-3xl animate-float-delayed"></div>
      </div>
          ...
          <div className="space-y-8 animate-fade-up">
            ...
            <div className="flex flex-col sm:flex-row gap-4 animation-delay-200 animate-fade-up">
              <Button 
                ...
                size="lg" 
                className="gradient-primary text-white hover:opacity-90 hover:scale-105 transition-all duration-300 shadow-orange hover:shadow-xl"
              >
                Get Started
